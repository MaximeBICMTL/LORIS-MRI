...
class Eeg:
    ...
    def __init__(
        self, env: Env, data_type: BidsEegDataType, session: DbSession, db: Database, verbose: bool, data_dir: str,
    ...
    def fetch_and_insert_eeg_files(self, derivatives=False, detect=True):
        ...
        for eeg_file in eeg_files:
            ...
            modality = get_check_bids_physio_modality(self.env, self.data_type.name)
