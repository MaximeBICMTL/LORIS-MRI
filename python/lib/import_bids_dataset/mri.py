...
def import_bids_mri_acquisition(
    ...
    file_type, file_hash, scan_type = group_errors_tuple(
        ...
        lambda: get_check_bids_imaging_file_type(env, acquisition.nifti_path.name),
    ...
    if acquisition.sidecar is not None:
        add_bids_mri_sidecar_file_parameters(env, acquisition.sidecar, file_parameters)
        ...
        file_parameters['bids_json_file_blake2b_hash'] = compute_file_blake2b_hash(acquisition.sidecar.path)
